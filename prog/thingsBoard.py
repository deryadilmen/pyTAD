...
def getTokenRead(dev,deviceID,ts1,et1,username,pwd,keys,folderOut):
    print(' checking ', folderOut+os.sep+"token" + dev + ".txt")
...
def scrapeTB(config,wgetData,folderOut):
    ...
    while True:
        ...
        print('Sleeping 1 min , last values ', format(tt)+' '+format(lev))
        time.sleep(60)
